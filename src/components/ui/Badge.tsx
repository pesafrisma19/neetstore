...
export const Badge: React.FC<BadgeProps> = ({
  ...
  const baseStyles = 'inline-flex items-center justify-center font-black uppercase tracking-wider border-[length:var(--nb-border-width-sm)] border-[var(--nb-border)] rounded-[var(--nb-radius-badge)] select-none';
